                    ...
                    <table class="table table-striped tableDetailPengembalian">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><strong>{{ $pengembalian->where('id_anggota',
                                        $data->id_anggota)->sum('jumlah_hari_terlambat') }}
                                        Hari</strong></td>
                            </tr>
                            <tr>
                                <td colspan="4"></td>
                                ...
                                <td><strong>Rp.
                                        {{ number_format($pengembalian->where('id_anggota',
                                        $data->id_anggota)->sum('denda')) }}</strong>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
