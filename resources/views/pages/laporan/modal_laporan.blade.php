        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="filterModalLabel">
                    Filter Laporan Data Peminjaman Buku
            ...
            <div class="modal-body">
                <form action="{{ route('laporan.peminjaman-buku') }}" method="POST" id="submitForm">
                    @csrf
...
<script>
    ...
    form.method = 'POST';
    form.action = '{{ route("laporan.generateFakturPeminjaman") }}';
